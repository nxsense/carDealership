	...
	<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
		...
		<main role="main" class="inner cover">
			...
			<div class="col-md-7 col-lg-8">
				...
				<form class="needs-validation" action="${pageContext.request.contextPath}/makeBid" method="post" novalidate>
					<div class="row g-3">
						<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<%--@declare id="bidamount"--%><label for="bidAmount" class="form-label">Bid Amount</label> <input
							type="text" class="form-control" id="offer" placeholder=""
							value="" required name="offer">
						<div class="invalid-feedback">Valid phone number is required.</div>
					</div>
					<a href="${pageContext.request.contextPath}/makeBid"><button class="w-100 btn btn-primary btn-lg" type="submit">Submit</button></a>
				</form>
			</div>
